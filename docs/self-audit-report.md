...
| D-3 | Abierta (no es un error) | **Parcialmente resuelta (actualizado 2026-08-22).** A-14 (declarar/publicar la URL del repositorio) se cerró el 2026-08-19: repositorio público, commit de referencia `98e9457` (rama `main`) declarado en el `.docx`. Solo sigue bloqueada M-11 (declaración de originalidad/autoría), porque no se cuenta con la plantilla institucional de UTN FRM — no debe inventarse ese texto. |
